...
const emptyForm = { hasJob: false, monthlySalary: '', monthlyExpenses: '' };
...
export const FinancialPage = () => {
  ...
  const totalExtraIncome = incomes.reduce((total, income) => total + (Number(income.amount) || 0), 0);
