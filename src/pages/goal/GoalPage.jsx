...
import { ArrowDownToLine, ArrowUpFromLine, Camera, Check, CircleAlert, Clock3, History, LoaderCircle, Pencil, Plus, Target, Trash2 } from 'lucide-react';
...
import { formatGoalTime, getGoalTimeDetails } from '../../utils/goalTime.js';
...
export const GoalPage = () => {
  ...
  const goalId = goal?._id || goal?.gid || goal?.id;
  const { transactions, isLoading: isTransactionsLoading, error: transactionsError, loadTransactions } = useTransaction(goalId);
